...
class Exp(BaseExp):
    ...
    def get_model(self, adversarial=False, attack_mode=None):
        ...
        self.adversarial = adversarial  # added by F&F attack
        ...
        if getattr(self, "model", None) is None:
            ...
            head = YOLOXHead(self.num_classes, self.width,
                             ...
                             adversarial=self.adversarial,  # added by F&F attack, 表示是否进行攻击
                             attack_mode=attack_mode)
            self.model = YOLOX(backbone, head, adversarial=adversarial)
